...
that gave the smallest sum of squares of errors $\text{SSE} =\Sigma (x - \bar{x})^2$m but the same principle
gives solutions for linear least squares regression, multiple regression, smoothing spline and non-linear models,
...
by a simple geometric argument. But it is the purpose of this vignette to show how least squares problems can be
